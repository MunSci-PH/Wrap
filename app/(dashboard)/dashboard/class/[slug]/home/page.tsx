...
import { BarChart3, ClipboardList, LoaderCircle, Plus, Settings, Users } from "lucide-react";
    ...
    <ContentLayout title="Class View">
      ...
      <div className="grid gap-4 md:grid-cols-4">
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold">{classData.enrolled?.length}</div>
          </CardContent>
        </Card>
      ...
      <Tabs defaultValue="overview" className="space-y-4">
          ...
          <div className="grid gap-6 md:grid-cols-2">
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>Submission status for active assignments</CardDescription>
              </CardHeader>
        ...
        <TabsContent value="students" className="space-y-4">
          <div className="flex items-center justify-between">
            <h3 className="text-lg font-semibold">Students ({classData.enrolled?.length})</h3>
